...
import logo from '../../assets/img/geovision-brand-sm.svg';
import geovisionLogo from '../../assets/img/geovision-logo.svg';
import geovisionLogoDark from '../../assets/img/geovision-logo-dark.svg';
        ...
        <div className="menu-header">
            <span>
                <Link className="navbar-brand" to="/">
                    ...
                    {theme === "light"
                        ? <img className="brand-img img-fluid logo-light" src={geovisionLogo} alt="brand" />
                        : <img className="brand-img img-fluid logo-dark" src={geovisionLogoDark} alt="brand" />
                    }
                </Link>
