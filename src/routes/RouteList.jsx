...
import ContactCompanies from "../views/Contact/Companies";
...
import KanbanSummary from "../views/Scrumboard/KanbanSummary/index";
import Pipeline from "../views/Scrumboard/Pipeline";
import ProjectsBoard from "../views/Scrumboard/ProjectsBoard";
import Equipment from "../views/Logistics/Equipment";
import StockLocations from "../views/Logistics/StockLocations";
import CrewMembers from "../views/Logistics/CrewMembers";
import Vehicles from "../views/Logistics/Vehicles";
import Repairs from "../views/Logistics/Maintenance/Repairs";
import Inspections from "../views/Logistics/Maintenance/Inspections";
import LostEquipment from "../views/Logistics/Maintenance/LostEquipment";
import InventoryCounts from "../views/Logistics/Maintenance/InventoryCounts";
import Requests from "../views/Logistics/Requests";
...
export const routes = [
    ...
    { path: 'apps/taskboard/summary', exact: true, component: KanbanSummary },
    { path: 'apps/taskboard/pipeline', exact: true, component: Pipeline },
    { path: 'apps/logistics/requests', exact: true, component: Requests },
    { path: 'apps/logistics/equipment', exact: true, component: Equipment },
    { path: 'apps/logistics/stock-locations', exact: true, component: StockLocations },
    { path: 'apps/logistics/crew-members', exact: true, component: CrewMembers },
    { path: 'apps/logistics/vehicles', exact: true, component: Vehicles },
    { path: 'apps/logistics/maintenance/repairs', exact: true, component: Repairs },
    ...
    // Tasks (maps to same Todo components, just rebranded)
    { path: 'apps/tasks/task-list', exact: true, component: TaskList },
    ...
    // Accounts (renamed from Invoices)
    { path: 'apps/accounts/invoice-list', exact: true, component: InvoiceList },
    { path: 'apps/accounts/invoice-templates', exact: true, component: InvoiceTemplates },
    { path: 'apps/accounts/create-invoice', exact: true, component: CreateInvoice },
    { path: 'apps/accounts/invoice-preview', exact: true, component: PreviewInvoice },
    // Keep old invoice paths for backwards compat
