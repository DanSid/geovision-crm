...
export const data = [
    ...
    {
        starred: false,
        name: [{ icons: "folder-2-fill", iconBg: "warning", fileName: "Geovision - CRM - v1.0", fileType: "folder" }],
    ...
    {
        starred: true,
        name: [{ icons: "folder-5-fill", iconBg: "warning", fileName: "Geovision", fileType: "folder" }],
        sharing: [{ blank: true }],
