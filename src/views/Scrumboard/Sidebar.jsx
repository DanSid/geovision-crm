...
import { Archive, Book, BarChart2, Globe, Layout, Lock, MoreVertical, Plus, Settings, Star, Trash2, UserCheck, ZapOff } from 'react-feather';
                    ...
                    <div className="menu-content-wrap">
                        ...
                        <div className="menu-group">
                            <Nav as="ul" className="nav-light navbar-nav flex-column">
                                <Nav.Item as="li" className={at('kanban-board') ? 'active' : ''}>
                                    <Nav.Link as={Link} to="/apps/taskboard/kanban-board">
                                        <span className="nav-icon-wrap">
                                            <span className="feather-icon"><Layout /></span>
                                        </span>
                                        <span className="nav-link-text">Kanban Board</span>
                                    </Nav.Link>
                                </Nav.Item>
                                <Nav.Item as="li" className={at('summary') ? 'active' : ''}>
                                    <Nav.Link as={Link} to="/apps/taskboard/summary">
                                        <span className="nav-icon-wrap">
                                ...
                                <Nav.Item as="li">
                                    <Nav.Link>
                                        ...
                                        <span className="nav-link-text">Starred Boards</span>
                                    </Nav.Link>
                                </Nav.Item>
                                <Nav.Item as="li">
                                    <Nav.Link>
                                ...
                                <Nav.Item as="li">
                                    <Nav.Link>
                                        <span className="nav-icon-wrap">
                                            <span className="feather-icon"><UserCheck /></span>
                                        </span>
                                    ...
                                    <div>
                                        <div className="media d-flex align-items-center">
                                            ...
                                            <div className="media-body">
                                                <div>
                                                    <div className="name">Geovision</div>
                                                </div>
                                            </div>
                                        </div>
