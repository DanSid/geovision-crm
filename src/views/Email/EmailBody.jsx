...
import sign from '../../assets/img/geovision-logo.svg';
                    ...
                    <div className="accordion-item">
                        ...
                        <div id="simple-collapseOne" className="accordion-collapse collapse">
                            <div className="accordion-body">
                                <p>Hi Hencework,</p>
                                <p>We'd like to let you know that an update to your account is now available.</p>
