...
const AudioCallModal = ({ show, hide, avatar, userName }) => {
    ...
    return (
        <Modal show={show} onHide={hide} fullscreen={fullScreen} centered size='xl' dialogClassName="chatapp-call-window" className="ps-0" >
            <Modal.Header className="header-wth-bg">
                <Modal.Title as="h6" className="text-muted">Geovision Audio Call</Modal.Title>
...
export default connect(mapStateToProps)(AudioCallModal);